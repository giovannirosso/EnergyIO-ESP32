#ifndef MAIN_NRF24_H_
#define MAIN_NRF24_H_
...
#define nRF24_ADDR_LEN    5                        //Device addrees length:3~5 bytes
#define nRF24_CONFIG ((1<<EN_CRC) | (0<<CRCO) ) //enable CRC and CRC data len=1;nRF24_CONFIG ==1000B
